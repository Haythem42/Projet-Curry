...
<!DOCTYPE html>
    ...
    <body>
        ...
        <!-- Displaying the error / success message after the user has made something -->
        <?php 
        ...
        <!-- Button which redirect to the creation page -->
        <?php if(Auth::can(2)): ?>
        <div class="w-90 f-r" style="margin-top: 20px;margin-right: 50px;">
            <div class="flex justify-content-center">
                <a href="/fireman/create" class="btn btn-success w-15 b-radius margin-r-80px">
        ...
        <div class="container" style="background-color: white;border-radius: 2%; padding: 60px;">
            <!-- Table which displays all the firemen -->
                    ...
                    for($i=0; $i < count($firemen);$i++) { ?>
                        ...
                        <tr style="line-height : 75px;">
                            ...
                            <td class="text-center">
                                <a href="/fireman/modify/<?php echo($firemen[$i]->getMatricule());?>" class="btn btn-warning w-75 b-radius">
            ...
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="separator-50px"></div>
                        <form action="/fireman/erase" method="POST">
        ...
        <!-- Modal when showing information -->
        ...
        <script>
            ...
            // Function which associates the id of the delete button with the input in the deleting modal
            function matchId(e) {
            ...
            // Function which creates the datatable when the page is loaded
            $(document).ready( function () {
